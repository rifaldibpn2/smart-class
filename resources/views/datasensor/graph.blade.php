...
@section('content')
            ...
            <div class="row mb-2">
                <div class="col-sm-6">
                    ...
                    <div class="form-group">
                        ...
                        <select id="pilihKelas" onchange="handleSelectChange()" class="form-control select2"
                            style="width: 100%;">
    ...
    <script type="text/javascript">
        function handleSelectChange(event) {
            var idUrl = document.getElementById("pilihKelas").value;
        ...
        function handleDateChange(event) {
            ...
            window.location.href = "{{ url('/datasensor/grafik/?id=') }}" + $("#pilihKelas").val() + ('&from=') + min + (
                '&to=') + max;
        };
        ...
        document.getElementById("menuAktif").innerHTML =
            '<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false"><li id="beranda" class="nav-item"><a href="/home" class="nav-link"><i class="nav-icon fas fa-tachometer-alt"></i><p>Beranda</p></a></li><li class="nav-item menu-open"><a href="#" class="nav-link active"><i class="nav-icon fas fa-chart-pie"></i><p>Data Sensor<i class="right fas fa-angle-left"></i></p></a><ul class="nav nav-treeview"><li class="nav-item"><a href="/datasensor/table" class="nav-link"><i class="far fa-circle nav-icon"></i><p>Tabel</p></a></li><li class="nav-item"><a href="/datasensor/grafik" class="nav-link active"><i class="far fa-circle nav-icon"></i><p>Grafik</p></a></li></ul></li><li id="kelas" class="nav-item"><a href="/kelas" class="nav-link"><i class="nav-icon fas fa-tint"></i><p>Kelas</p></a></li>@if (Auth::user()->role == 'admin')<li id="user" class="nav-item"><a href="/admin/user" class="nav-link"><i class="nav-icon fas fa-user"></i><p>Manage User</p></a></li>@endif</ul>';
